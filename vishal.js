...
async function main() {
    ...
    .freezeWith(client)
	const contractExecuteSubmit = await contractExecuteTx.sign(key);
    const contractExecuteSubmitp = await contractExecuteSubmit.execute(client);
	const contractExecuteRx = await contractExecuteSubmitp.getReceipt(client);
